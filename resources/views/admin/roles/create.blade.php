...
<div class="page-header mb-4">
    <div>
        ...
        <h1 class="mb-1">Tambah Level</h1>
        <div class="page-header-sub">Buat level baru dan atur hak aksesnya</div>
    </div>
</div>

<div class="card border-0 shadow-sm">
    <div class="card-body p-4">
        <form action="{{ url('/cms/roles') }}" method="POST" id="roleForm">
            @csrf
            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="contoh: Editor, Writer, dll">
                            ...
                            <div class="perm-group-body">
                                ...
                                <div class="perm-checkbox-wrapper">
                                    ...
                                    <label class="form-check-label" for="perm_{{ $perm->id }}">
                                        <span class="perm-action-icon" style="background: {{ in_array($perm->id, old('permissions', [])) ? '#EFF6FF' : '#F8FAFC' }}; color: {{ in_array($perm->id, old('permissions', [])) ? '#2563EB' : '#94A3B8' }};">
